// ==UserScript==
// @name         14. DS 160 Security Part 2
// @namespace    http://tampermonkey.net/
// @version      2026-03-06-v7.1
// @description  Fix hoàn toàn: Click 1 lần điền No hết (delay 1300ms + trigger mạnh)
// @author       Mỹ
// @match        https://ceac.state.gov/GenNIV/General/complete/complete_securityandbackground2.aspx?node=SecurityandBackground2
...
(function() {
    ...
    const mapping = {
        arrested:              { radio: "Arrested",              explainField: "tbxArrested" },
        controlledSubstances:  { radio: "ControlledSubstances",  explainField: "tbxControlledSubstances" },
        prostitution:          { radio: "Prostitution",          explainField: "tbxProstitution" },
        moneyLaundering:       { radio: "MoneyLaundering",       explainField: "tbxMoneyLaundering" },
        humanTrafficking:      { radio: "HumanTrafficking",      explainField: "tbxHumanTrafficking" },
        assistedSevereTrafficking: { radio: "AssistedSevereTrafficking", explainField: "tbxAssistedSevereTrafficking" },
        humanTraffickingRelated: { radio: "HumanTraffickingRelated", explainField: "tbxHumanTraffickingRelated" }
    };
    ...
    async function fillForm() {
        console.log("%c🚀 BẮT ĐẦU SECURITY PART 2 (v7.1 - Fix No mạnh nhất)", "color:#0066cc;font-weight:bold");
        ...
        console.log("%c✅ HOÀN TẤT SECURITY PART 2 v7.1!", "color:green;font-weight:bold");
        alert("✅ ĐÃ ĐIỀN XONG SECURITY PART 2 (v7.1)!\n• Click 1 lần điền No hết tất cả\n• Delay đã tối ưu\nKiểm tra lại rồi Next nhé Paul!");
    }

    function addButton() {
        if (document.getElementById("autoFillSec2")) return;
        const btn = document.createElement("button");
        btn.id = "autoFillSec2";
        btn.innerHTML = "🛠 AUTO FILL SECURITY PART 2";
